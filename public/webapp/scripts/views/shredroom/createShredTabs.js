            ...
            renderKeyboard : function () {
                ...
                function startNote(e) {
                    ...
                    if (frq) {
                        ...
                        that.$("#tblNotes tbody").append("<tr><td>"+e.currentTarget.id+"</td><td>"+thisNote.noteLength+"</td></tr>");
                ...
                function playAll(e) {
                    var o, t=ctx.currentTime, arrayLength = arrNotes.length, playlength = 0, bpm = parseInt(that.$("#bpm").val());
                ...
                that.$("use").mousedown(startNote);
                that.$("use").mouseup(stopNote);
                that.$("#playAll").click(playAll);
